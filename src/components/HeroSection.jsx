        ...
        <div className="relative max-w-6xl mx-auto px-4 py-20 lg:py-24">
          <div className="grid gap-10 lg:grid-cols-[1.4fr_0.9fr] lg:items-center">
            <div className="space-y-6">
              ...
              <motion.h1 initial={{opacity:0,y:24}} animate={{opacity:1,y:0}} transition={{duration:0.7}} className="text-4xl font-black leading-tight text-white sm:text-5xl lg:text-6xl">Beautiful spaces, lasting paint finishes for Chennai homes and workplaces.</motion.h1>
              ...
              <motion.div initial={{opacity:0,y:24}} animate={{opacity:1,y:0}} transition={{duration:0.9}} className="flex flex-col gap-3 sm:flex-row sm:items-center">
                ...
                <a href="https://wa.me/919941588083?text=Hello%20Dhanalakshmi%20Painting%20Contractor,%20I%20need%20a%20painting%20estimate" target="_blank" rel="noreferrer" className="inline-flex items-center justify-center rounded-full border border-white/15 bg-white/10 px-6 py-3 text-sm font-semibold text-white transition hover:bg-white/15">Chat on WhatsApp</a>
              </motion.div>
            </div>
