    ...
    "
      ...
      "
                          ...
                          <div className="min-w-0">
                            ...
                            <p className="text-lg md:text-lg text-slate-400">
                              {review.location}
                            </p>
                        ...
                        <div className="px-2 pb-5">
                          <div className="flex gap-4 overflow-x-auto no-scrollbar">
                            {review.images.map((image, index) => (
                              <div
                                key={index}
                                className="flex-shrink-0 w-56 h-56 rounded-2xl overflow-hidden border border-white/10 bg-slate-900"
                              >
                                <img
                                  src={image}
                                  alt={`Review ${index + 1}`}
                                  className="w-full h-full object-contain cursor-pointer transition duration-500 hover:scale-105"
                                  onClick={() => {
